...
function LoginNavbar({ history }) {
    return (
        <div className='min-h-screen bg-gray-100 text-gray-900 flex justify-center'>
        {/* <Navbar/> */}
         <ToastContainer />
          <div className='max-w-screen-xs m-0 sm:m-25 bg-white shadow sm:rounded-lg flex justify-center flex-1'>
              ...
              <div className='mt-12 flex flex-col items-center'>
                ...
                <div className='w-full flex-1 mt-8 text-indigo-500'>
                  ...
                  <div className='mx-auto max-w-xs relative '>
                    ...
                    {/* <Link
                      to='/create/post'
                      className='mt-5 tracking-wide font-semibold bg-yellow-500 text-gray-100 w-full py-4 rounded-lg hover:bg-green-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none'
                    >
                      <i className='fas fa-sign-in-alt  w-6  -ml-2' />
